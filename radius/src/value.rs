...
impl Value {
    ...
    pub fn depends(&self, bv: BV<Arc<Btor>>) -> bool {
        match self {
            ...
            Value::Symbolic(a)  => format!("{:?}", a)
                .contains(bv.get_symbol().unwrap())
        }
    }
